<template>
  <section class="mj-template mj-template--list">
    <section class="mj-template--list__header">
      <base-search
        v-if="baseSearch"
        v-bind="baseSearch"
      ></base-search>
    ...
    <section
      ...
      class="mj-template--list__body"
    >
      <section class="mj-template--list__buttons">
        <base-buttons
          v-if="baseButtons"
          v-bind="baseButtons"
        ></base-buttons>
      </section>
      <section class="mj-template--list__table">
        <base-table
          v-if="baseTable"
      ...
      <section class="mj-template--list__pagination">
        <base-pagination
          v-if="basePagination"
...
export default defineComponent({
  setup(props, context) {
    ...
    const baseButtons = useBaseButtons({
      buttons: ['add', 'edit', 'delete', { label: '测试弹出层', key: 'show-dialog' }],
      events: {
        add() {
